...
export default function HomePage() {
  return <div className="nd-page">
    ...
    </div><aside className="nd-status-panel"><p className="nd-eyebrow">Data status</p><strong>Project API</strong><p>PostgreSQL-backed project register with imported PAIMANA observations.</p></aside></div></section>
